...
function creation_data(file_name::String, file_loc_name::String, file_people_name::String, file_driver_name::String, nb_line, nb_point, nb_people, nb_bus) #nb_point = tableau de nombre de points pour chaque cercle
...
creation_data("Data/line/mTSP_matrix.csv", "Data/line/node_coordinates.csv","Data/line/customer_requests.csv", "Data/line/driver_shifts.csv",5, [15,15,15,15,15], 30, 5)
